...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			...
			ECE a=new ECE();
			String p=a.displayCourseDetails("ECE");
			
			System.out.println(p);//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			...
			Mechanical b=new Mechanical();
			String q=b.displayCourseDetails("Mechanical");
			
			System.out.println(q);//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			CSE c=new CSE();
			String r=c.displayCourseDetails("CSE");
			
			System.out.println(r);//call the function of the class that you initialized
			break;
		}
		default:
